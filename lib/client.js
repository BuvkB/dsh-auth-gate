	...
	factory: (require) => {
		...
		*/
		...
		function LogoutAction() {
			if (useAuthenticated() !== true) return null;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LogoutSubmitButton, {});
		}
		function HeroLogoutAction({ useSessions }) {
			const authenticated = useAuthenticated();
			const { hasRealSession } = (typeof useSessions === "function" ? useSessions : (selector) => selector({}))((state) => {
				const current = state.current;
				return { hasRealSession: (current !== void 0 && state.byId?.[current]?.blank === false) === true };
			});
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LogoutSubmitButton, {})
			});
		}
		//#endregion
