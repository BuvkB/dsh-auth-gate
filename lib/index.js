 ...
 */
function mountAuthEndpoints(server, config, auth, resolveToken, usersPath, limiter, log) {
...
export function apply(ctx, config) {
    ...
    ctx.effect(() => mountAuthEndpoints(server, config, auth, resolveToken, usersPath, limiter, log), "dsh-auth-gate: auth endpoints");
